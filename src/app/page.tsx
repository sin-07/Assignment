      ...
      <Card className="w-full max-w-md bg-white shadow-lg border-0">
        ...
        <CardContent className="space-y-4 px-8 pb-8">
          ...
          <Button
            ...
            className="w-full h-12 my-3 border-gray-300 hover:bg-gray-50 disabled:bg-gray-50 disabled:text-gray-400 bg-white text-gray-700 font-normal rounded-full"
